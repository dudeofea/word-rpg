...
Sha256.hash = function(msg) {
    ...
    for (var i=0; i<N; i++) {
        ...
        for (var t=16; t<64; t++) W[t] = (Sha256.rho1(W[t-2]) + W[t-7] + Sha256.rho0(W[t-15]) + W[t-16]) & 0xffffffff;
...
Sha256.rho0  = function(x) { return Sha256.ROTR(7,  x) ^ Sha256.ROTR(18, x) ^ (x>>>3);  };
Sha256.rho1  = function(x) { return Sha256.ROTR(17, x) ^ Sha256.ROTR(19, x) ^ (x>>>10); };
